...
namespace ACE.Server.WorldObjects
{
    ...
    partial class WorldObject
    {
        ...
        public double? LastnexustokenDropTime
        {
            get => GetProperty(PropertyFloat.LastnexustokenDropTime);
            set { if (!value.HasValue) RemoveProperty(PropertyFloat.LastnexustokenDropTime); else SetProperty(PropertyFloat.LastnexustokenDropTime, value.Value); }
        }

        public double? Last2nexustokenDropTime
        {
            get => GetProperty(PropertyFloat.Last2nexustokenDropTime);
            set { if (!value.HasValue) RemoveProperty(PropertyFloat.Last2nexustokenDropTime); else SetProperty(PropertyFloat.Last2nexustokenDropTime, value.Value); }
        }

        public double? nexustokenDropDay
        {
            get => GetProperty(PropertyFloat.nexustokenDropDay);
            set { if (!value.HasValue) RemoveProperty(PropertyFloat.nexustokenDropDay); else SetProperty(PropertyFloat.nexustokenDropDay, value.Value); }
        }

        public double? nexustokenDropsToday
        {
            get => GetProperty(PropertyFloat.nexustokenDropsToday);
            set { if (!value.HasValue) RemoveProperty(PropertyFloat.nexustokenDropsToday); else SetProperty(PropertyFloat.nexustokenDropsToday, value.Value); }
        }
