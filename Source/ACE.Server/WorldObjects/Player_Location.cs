...
0x003F,     // Dragon Cave
0x0031,     // Venom Tusker
0x0D4A,     // Hopeslayers Temple
0x018E,     // Dark Fuin Halls
0x5774,     // The Red Vaults
0x0186,     // Decimation Golems
0x01FC,     // Pancake Golems
0x02C7,     // Wraith Dungeon
0x6146,     // Baishi Hive
0x019E,     // Enlightened Drudge Hideout
0x6543,     // Aerbax - Lesser Battle Dungeon
0x002B,     //Egg Orchard
0x0064,     //Egg Orchard East
0x002A,     //Path of the Blind
0x6145,     //Matron Hive West
0x6347,     //Matron Hive North
0x584C,     //Olthoi Brood Hive 80+
0x5E48,     //Olthoi Brood Hive 60+
0x0010,     //War Room
0x0003,     //Niffis Fighting Pits
0x01EC,     // Defiled Temple Middle Wing 1 60+ Tursh
0x000D,     // Defiled Temple Middle Wing 2
0x0012,     // Defiled Temple Middle Wing 3
0x0009,     // Defiled Temple Upper Wing 1
0x000E,     // Defiled Temple Upper Wing 2
0x0013,     // Defiled Temple Upper Wing 3
0x0291,     // Singularity Bore
0x0D07,     // Caul Towers
0x0C09,     // Caul Towers 2
0x6548,     // The Orphangage
0x070F,     // Caul 1
0x0909,     // Caulcano
0x2D5B,     // Renegade Fortress 1
0x6248,     // Renegade Fortress
0x41DD,     // Blighted Deso Moars 1
0x00C4,     // Blighted Deso Moars 2
0x4AF3,    // Blighted Verdant Moars 1
0x00C6,    // Blighted Verdant Moars 2
0xF072,    // Lacuna Landblocks
0x5949,    // Tusker Lacuna
0x01CB,    // Penguin Cave Hatchery


// Ravaged Islands
0xE4D6,     // Ravaged Islands
0xE4D5,     // Ravaged Islands
0xE5D6,     // Ravaged Islands
0xE5D5,     // Ravaged Islands
0xE5D4,     // Ravaged Islands
0xE5D3,     // Ravaged Islands
0xE4D3,     // Ravaged Islands
0xE4D0,     // Ravaged Islands
0xE3D0,     // Ravaged Islands
0xE2D5,     // Ravaged Islands
0xE3D1,     // Ravaged Islands
0xE3D2,     // Ravaged Islands
0xE3D3,     // Ravaged Islands
0xE3D4,     // Ravaged Islands
0xE3D5,     // Ravaged Islands
0xE3D6,     // Ravaged Islands
0xE4D2,     // Ravaged Islands
0xE4D1,     // Ravaged Islands
0xE5D1,     // Ravaged Islands
0xE5D0,     // Ravaged Islands
0xE5CF,     // Ravaged Islands
0xE6CF,     // Ravaged Islands
0xE5CE,     // Ravaged Islands
0xE4CE,     // Ravaged Islands

// Hopeslayer's Reach
// 0x0D4A already listed above (Hopeslayers Temple)
0x0D49,     // Hopeslayer's Reach
0x0E49,     // Hopeslayer's Reach
0x0E48,     // Hopeslayer's Reach
0x0F48,     // Hopeslayer's Reach
0x1048,     // Hopeslayer's Reach
0x1049,     // Hopeslayer's Reach
0x0F49,     // Hopeslayer's Reach
0x0E4A,     // Hopeslayer's Reach

// Hidden Cavern
0x5F48      // Hidden Cavern
        };
