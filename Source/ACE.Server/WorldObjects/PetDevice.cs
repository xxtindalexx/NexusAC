...
namespace ACE.Server.WorldObjects
{
    ...
    public class PetDevice : WorldObject
    {
        ...
        {
            return wo.WeenieClassId == 49485 || wo.WeenieClassId == 6548557;
        ...
        public void Refill(Player player, CraftTool spirit)
        {
            ...
            actionChain.AddAction(player, () =>
            {
                ...
                // Only consume the classic Encapsulated Spirit (49485). Do NOT consume 6548557.
                if (spirit.WeenieClassId == 49485)
                {
