...
namespace ACE.Server.Factories
{
    public static class LootTables
    {
        ...
        {      //  0|250|300|325|350|370|400|420|430|400+|420+|430+
                { 26, 33, 40, 47, 54, 61, 68, 71, 74, 71, 74, 81 }, // Axe
                { 24, 31, 38, 45, 51, 58, 65, 68, 71, 68, 71, 78 }, // Dagger
                { 13, 16, 20, 23, 26, 30, 33, 36, 38, 36, 38, 45 }, // MultiDagger
                { 22, 29, 36, 43, 49, 56, 63, 66, 69, 66, 69, 76 }, // Mace
                { 25, 32, 39, 46, 52, 59, 66, 69, 72, 69, 72, 79 }, // Spear
                { 24, 31, 38, 45, 51, 58, 65, 68, 71, 68, 71, 78 }, // Sword
                { 12, 16, 19, 23, 26, 30, 33, 36, 38, 36, 38, 45 }, // MultiSword
                { 23, 30, 36, 43, 50, 56, 63, 66, 70, 66, 70, 77 }, // Staff
                { 20, 26, 31, 37, 43, 48, 54, 56, 59, 56, 59, 66 }  // UA
        };

        public static readonly int[,] LightWeaponDamageTable =
        {      //  0|250|300|325|350|370|400|420|430|400+|420+|430+
                { 22, 28, 33, 39, 44, 50, 55, 58, 61, 58, 61, 68 }, // Axe
                { 18, 24, 29, 35, 40, 46, 51, 54, 58, 54, 58, 65 }, // Dagger
                {  7, 10, 13, 16, 18, 21, 24, 27, 28, 27, 28, 35 }, // MultiDagger
                { 19, 24, 29, 35, 40, 45, 50, 53, 57, 53, 57, 64 }, // Mace
                { 21, 26, 32, 37, 43, 48, 53, 56, 60, 56, 60, 67 }, // Spear
                { 20, 25, 31, 36, 41, 47, 52, 55, 58, 55, 58, 65 }, // Sword
                {  7, 10, 13, 16, 18, 21, 24, 25, 28, 25, 28, 35 }, // MultiSword
                { 19, 24, 30, 35, 40, 46, 51, 54, 57, 54, 57, 64 }, // Staff
                { 17, 22, 26, 31, 35, 40, 44, 46, 48, 46, 48, 55 }  // UA
        };

        public static readonly int[,] TwoHandedWeaponDamageTable =
        {      //  0|250|300|325|350|370|400|420|430|400+|420+|430+
                { 13, 17, 22, 26, 30, 35, 39, 42, 45, 39, 42, 52 }, // Cleaving
                { 14, 19, 23, 28, 33, 37, 42, 45, 48, 42, 45, 55 }  // Spears
        };
        ...
        {
            new float[] { 2.1f, 2.1f, 2.2f, 2.3f, 2.4f, 2.4f, 2.4f, 2.4f, 2.4f, 2.47f }, // Bow
            new float[] { 2.4f, 2.4f, 2.5f, 2.55f, 2.65f, 2.65f, 2.65f, 2.65f, 2.65f, 2.72f }, // Crossbow
            new float[] { 2.3f, 2.3f, 2.4f, 2.5f, 2.6f, 2.6f, 2.6f, 2.6f, 2.6f, 2.67f }  // Thrown
        };
