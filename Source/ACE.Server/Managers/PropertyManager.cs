...
namespace ACE.Server.Managers
{
    public static class PropertyManager
    {
        ...
        internal static bool ModifyFloat(string v, float val)
        {
    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<bool>> DefaultBooleanProperties =
            DictOf(
                ...
                ("magic_cast_delay_enabled", new Property<bool>(true, "Enable delayed broadcast smoothing during magic casting.")),
                ("magic_cast_delay_debug", new Property<bool>(false, "Verbose logging for magic cast delay decisions."))
                );
        ...
        public static readonly ReadOnlyDictionary<string, Property<double>> DefaultDoubleProperties =
            DictOf(
                ...
                ("magic_start_cast_delay_threshold", new Property<double>(0.05, "Magic cast-delay: start threshold (seconds).")),
                ("magic_end_cast_delay_threshold", new Property<double>(0.40, "Magic cast-delay: end threshold (seconds).")),
                ("magic_broadcast_delay", new Property<double>(0.08, "Magic cast-delay: hold duration (seconds).")),
